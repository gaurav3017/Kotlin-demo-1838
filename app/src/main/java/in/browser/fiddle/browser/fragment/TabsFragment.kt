package `in`.browser.fiddle.browser.fragment

import `in`.browser.fiddle.R
import `in`.browser.fiddle.browser.TabsManager
import `in`.browser.fiddle.browser.TabsView
import `in`.browser.fiddle.browser.fragment.anim.HorizontalItemAnimator
import `in`.browser.fiddle.browser.fragment.anim.VerticalItemAnimator
import `in`.browser.fiddle.controller.UIController
import `in`.browser.fiddle.di.injector
import `in`.browser.fiddle.extensions.color
import `in`.browser.fiddle.extensions.desaturate
import `in`.browser.fiddle.extensions.drawTrapezoid
import `in`.browser.fiddle.preference.UserPreferences
import `in`.browser.fiddle.utils.DrawableUtils
import `in`.browser.fiddle.utils.ThemeUtils
import `in`.browser.fiddle.utils.Utils
import `in`.browser.fiddle.view.BackgroundDrawable
