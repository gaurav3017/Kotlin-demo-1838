package `in`.browser.fiddle.search
...
import `in`.browser.fiddle.database.WebPage
...
import `in`.browser.fiddle.search.suggestions.NoOpSuggestionsRepository
import `in`.browser.fiddle.search.suggestions.SuggestionsRepository
