package `in`.browser.fiddle.dialog

import `in`.browser.fiddle.MainActivity
import `in`.browser.fiddle.R
import `in`.browser.fiddle.constant.HTTP
import `in`.browser.fiddle.controller.UIController
import `in`.browser.fiddle.database.Bookmark
import `in`.browser.fiddle.database.asFolder
...
import `in`.browser.fiddle.extensions.copyToClipboard
import `in`.browser.fiddle.html.bookmark.BookmarkPageFactory
import `in`.browser.fiddle.preference.UserPreferences
import `in`.browser.fiddle.utils.IntentUtils
import `in`.browser.fiddle.utils.UrlUtils
