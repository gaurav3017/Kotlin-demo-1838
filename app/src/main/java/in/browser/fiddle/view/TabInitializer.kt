package `in`.browser.fiddle.view

import `in`.browser.fiddle.R
import `in`.browser.fiddle.constant.SCHEME_BOOKMARKS
import `in`.browser.fiddle.constant.SCHEME_HOMEPAGE
import `in`.browser.fiddle.di.DiskScheduler
import `in`.browser.fiddle.di.MainScheduler
import `in`.browser.fiddle.extensions.resizeAndShow
import `in`.browser.fiddle.html.HtmlPageFactory
import `in`.browser.fiddle.html.bookmark.BookmarkPageFactory
import `in`.browser.fiddle.html.download.DownloadPageFactory
