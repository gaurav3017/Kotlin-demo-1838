package `in`.browser.fiddle.preference

import `in`.browser.fiddle.constant.DEFAULT_ENCODING
import `in`.browser.fiddle.constant.NO_PROXY
import `in`.browser.fiddle.constant.SCHEME_HOMEPAGE
import `in`.browser.fiddle.device.ScreenSize
import `in`.browser.fiddle.di.UserPrefs
import `in`.browser.fiddle.preference.delegates.booleanPreference
import `in`.browser.fiddle.preference.delegates.intPreference
import `in`.browser.fiddle.preference.delegates.stringPreference
import `in`.browser.fiddle.search.engine.GoogleSearch
import `in`.browser.fiddle.utils.FileUtils
